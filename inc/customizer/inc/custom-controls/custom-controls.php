...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Minisite_Image_Checkbox_Custom_Control extends WP_Customize_Control {
 		/**
 		 ...
 		 */
  		public function enqueue() {
 			wp_enqueue_style( 'minisite-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/customizer.css', array(), '1.0', 'all' );
  		}
 		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Minisite_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
 		/**
 		 * The type of control being rendered
 		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Single_Accordion_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'minisite-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'minisite-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_style( 'fontawesome', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/font-awesome.min.css', array(), '4.6.3', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'minisite-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			//wp_enqueue_style( 'minisite-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'minisite-select2-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/js/select2.min.js', array( 'jquery' ), '4.0.6', true );
			wp_enqueue_script( 'minisite-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/js/customizer.js', array( 'minisite-select2-js' ), '1.0', true );
			wp_enqueue_style( 'minisite-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'minisite-select2-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/select2.min.css', array(), '4.0.6', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['minisitetinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['minisitetinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Minisite_Google_Font_Select_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->minisite_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->minisite_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['minisitefontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		 ...
		 */
		public function minisite_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function minisite_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/fonts/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/fonts/google-fonts-popularity.json';
			}
	...
	/**
 	 ...
 	 */
	class Minisite_Customize_Alpha_Color_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'minisite-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'minisite-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/inc/custom-controls/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	if ( ! function_exists( 'minisite_url_sanitization' ) ) {
		function minisite_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'minisite_switch_sanitization' ) ) {
		function minisite_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'minisite_radio_sanitization' ) ) {
		function minisite_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'minisite_sanitize_integer' ) ) {
		function minisite_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'minisite_text_sanitization' ) ) {
		function minisite_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'minisite_array_sanitization' ) ) {
		function minisite_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'minisite_hex_rgba_sanitization' ) ) {
		function minisite_hex_rgba_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'minisite_in_range' ) ) {
		function minisite_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'minisite_google_font_sanitization' ) ) {
		function minisite_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'minisite_date_time_sanitization' ) ) {
		function minisite_date_time_sanitization( $input, $setting ) {
