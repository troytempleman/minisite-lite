jQuery( document ).ready(function($) {
		...
		if(numRepeaterItems > 0) {
			...
			if(numRepeaterItems > 1) {
				...
				for (i = 1; i < numRepeaterItems; ++i) {
					minisiteAppendRow($(this), defaultValuesArray[i]);
				}
			}
		}
	});
	...
	$(this).find('.sortable').sortable({
		update: function(event, ui) {
			minisiteGetAllInputs($(this).parent());
		}
	});
	...
	$('.sortable').on('click', '.customize-control-sortable-repeater-delete', function(event) {
		...
		if(numItems > 1) {
			$(this).parent().slideUp('fast', function() {
				...
				$(this).remove();
				minisiteGetAllInputs(parentContainer);
			})
		}
		else {
			$(this).parent().find('.repeater-input').val('');
			minisiteGetAllInputs($(this).parent().parent().parent());
		}
	});
	...
	function minisiteAppendRow($element, defaultValue = '') {
	...
	function minisiteGetAllInputs($element) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		var indexes = $.map(bodyfontcontrol.minisitefontslist, function(obj, index) {
		...
		$.each(bodyfontcontrol.minisitefontslist[index].variants, function(val, text) {
		...
		$(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.minisitefontslist[index].category);

		minisiteGetAllSelects($(this).parent().parent());
	});
	...
	function minisiteGetAllSelects($element) {
		var selectedFont = {
	...
	$('.customize-control-tinymce-editor').each(function(){
		...
		var tinyMCEToolbar1String = _wpCustomizeSettings.controls[$(this).attr('id')].minisitetinymcetoolbar1;
		var tinyMCEToolbar2String = _wpCustomizeSettings.controls[$(this).attr('id')].minisitetinymcetoolbar2;
