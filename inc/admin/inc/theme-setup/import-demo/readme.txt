...
function TDI_plugin_page_setup( $default_settings ) {
	...
	$default_settings['page_title']  = esc_html__( 'Theme Demo Import' , 'minisite-lite' );
	$default_settings['menu_title']  = esc_html__( 'Import Demo Content' , 'minisite-lite' );
	$default_settings['capability']  = 'import';
	$default_settings['menu_slug']   = 'them'minisite-lite'return $default_settings;
}
add_filter( 'theme-demo-import/plugin_page_setup','minisite-lite'setup' );
`
